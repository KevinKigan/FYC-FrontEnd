...
export class ConocemeService {
  ...
  private _intro: string = 'Me gustaría darte la bienvenida a la página Find Your Car de la cual soy el creador. Me llamo Kevin y esta página web esta hecha ' +
    'como parte de mi educacion y aprendizaje en la Universidad de Alcalá. Gracias a esta enseñanza, puedo mostrar mis tres grandes pasiones, siendo estas ' +
  ...
  private _intro2: string = 'Esta página está tanto orientada al público general como a aquellos apasionados de los coches, dando apoyo y facilitando la obtención ' +
    ...
    'que se asemejan a aquel que tengas en mente para poder compararlos y que sientas que tu elección es la más acertada para ti y tener la posibilidad de ' +
